...
Universe::Universe(QString filename, Coord top_left) : top_left(top_left) {
...
void Universe::debug() { ((Quadrant *)root)->debug(top_level); }
...
Quadrant *Universe::set_rec(Coord current, size_t level, Quadrant *cell,
...
MiniCell *Universe::minicell(CellState nw, CellState ne, CellState sw,
                             CellState se) {
...
MacroCell *Universe::macrocell(size_t level, Quadrant *nw, Quadrant *ne,
...
size_t Universe::get_top_level() { return top_level; }

Coord Universe::get_top_left() { return top_left; }
